...
- Remove duplicate class definitions in 7 files (numpy_adapter, multi_file_adapter, lines, fill, loader, grid_layout, registry, style)
- All ruff lint checks now pass
